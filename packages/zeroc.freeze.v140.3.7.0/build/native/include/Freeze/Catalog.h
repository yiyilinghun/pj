...
#ifndef __Win32_Release_Catalog_h__
#define __Win32_Release_Catalog_h__
...
public:
    ...
    Catalog(const Freeze::ConnectionPtr& connection, const std::string& dbName, bool createDb, InputIterator first, InputIterator last, const Freeze::IceEncodingCompare& compare = Freeze::IceEncodingCompare())
        : Freeze::Map< ::std::string, ::Freeze::CatalogData, ::Freeze::MapKeyCodec< ::std::string>, ::Freeze::MapValueCodec< ::Freeze::CatalogData>, Freeze::IceEncodingCompare >(connection, dbName, keyTypeId(), valueTypeId(), createDb, first, last, compare)
    {
    }
